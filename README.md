...
我是 **Jiang**，一名专注于 AI 应用与 Agent 系统的开发者，主要使用 **Python** 与 **TypeScript**。

我关注可靠的 Agent 工作流、评测体系、开发者工具、数据产品与交互式 Web 应用，也持续为开源 AI 项目贡献功能、测试、安全加固与跨平台修复。

> **长期目标：** 构建可落地、可评测、可持续演进的 AI Agent 系统，并持续参与开源社区与 Codex 生态建设，贡献可复用的工具、Skills、工作流与工程实践。

```text
agent.role    = "AI Agent Developer"
...
- 可靠的 Agent 工作流、评测与可观测性
- AI 开发者工具、MCP 与可复用 Skills
- Codex 生态中的工具、工作流与开源协作
- 跨平台可靠性、安全边界与可复现工程
